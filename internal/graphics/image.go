...
func (i *Image) DrawImage(src *Image, vertices []float32, mode opengl.CompositeMode, filter Filter) {
	theCommandQueue.EnqueueDrawImageCommand(i, src, vertices, mode, filter)
}
